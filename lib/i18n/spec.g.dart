 ...
 * Strings: 1 
 * 
 * Built on 2021-07-15 at 16:38 UTC
 */
...
_SpecEn _t = _currLocale.translations;
_SpecEn get t => _t;
...
class Translations {
	...
	static _SpecEn of(BuildContext context) {
...
extension AppLocaleExtensions on AppLocale {
	_SpecEn get translations {
		switch (this) {
			case AppLocale.en: return _SpecEn._instance;
		}
	}
...
class _InheritedLocaleData extends InheritedWidget {
	...
	final _SpecEn translations; // store translations to avoid switch call
...
class _SpecEn {
	_SpecEn._(); // no constructor

	static final _SpecEn _instance = _SpecEn._();

	String get hello => 'Test Hello Fucking World';
...
late Map<AppLocale, Map<String, dynamic>> _translationMap = {
	AppLocale.en: {
		'hello': 'Test Hello Fucking World',
	},
};
